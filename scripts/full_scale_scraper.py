...
class FullScaleScraper:
    ...
    def run_full_scale_scraper(self, max_events=None, start_from=0):
        """Run the full scale scraper"""
        logger.info("🚀 Starting Full Scale Wikipedia Scraper")
        logger.info("=" * 50)
...
if __name__ == "__main__":
    ...
    # Start with a larger number for testing
    scraper.run_full_scale_scraper(max_events=50, start_from=0) 