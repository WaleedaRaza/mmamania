...
"""
Fixed Database Wipe
Wipes events and fights tables with proper WHERE clauses
"""
...
def wipe_tables():
    """Wipe the events and fights tables with proper WHERE clauses"""
    ...
    try:
        ...
        # Delete all fights with WHERE clause
        fights_response = requests.delete(
            f"{SUPABASE_URL}/rest/v1/fights",
            headers=headers,
            params={'id': 'gte.0'}  # Delete all records where id >= 0
        )
        ...
        # Delete all events with WHERE clause
